...
<body>
    ...
    <header>
        <nav>
            <div>
                    <a href="#" class="nav-item nav-logo"><h3>TICKETEASE</h3></a>
            ...
            <div>
                ...
                <!-- <a href="#" class="login nav-item" data-bs-toggle="modal" data-bs-target="#usersignupModal"><i class="fas fa-sign-in-alt" style="margin-right: 0.4rem;" ></i>SignUp</a> -->
    ...
    <div id="block">
        ...
        <section id="about">
            <div>
                <h2>About Us</h2>
                <h4>HOW AND WHERE ITS STARTED</h4>
                <p>
                TICKETEASE 
                It provides public transportation services primarily through buses. TICKETEASE operates city buses, intercity buses, and long-distance buses.
                It has a vast network of bus depots, offers online ticket booking, and provides passes and discounts for different passenger categories.
                TICKETEASE prioritizes passenger safety, and it has a customer support system for inquiries and assistance.
                </p>
            </div>
        </section>
        <section id="contact">
            <div id="contact-form">
                ...
                <form action="" autocomplete="off">
                    ...
                    <button type="submit" style="background:white;" name="feedback">submit</button>
                </form>
            </div>
        </section>
    </div>
